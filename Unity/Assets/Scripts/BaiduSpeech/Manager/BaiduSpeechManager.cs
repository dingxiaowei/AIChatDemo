...
namespace BaiduSpeech
{
    ...
    {
        private const string APP_ID = "31097940";
        private const string API_KEY = "SG2ymsyENznBX1OfXz7LIpkt";
        private const string SECRET_KEY = "WyIgOMM1OAetiOig9qcbzSLE0vGtOT42";
